...
この分野の用語の本家でもある。
TCMalloc は速いだけでなく、世界最大級のデータセンターで
何年も実測・改良され続けてきた。
...
その上で Google は、本番ワークロードで TCMalloc を実測した
...
TCMalloc は、多数スレッドで長時間稼働する C++ サーバに
