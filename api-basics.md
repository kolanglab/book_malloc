...
返された領域の中身は**不定**である。0 で埋まっていると思ってはいけない
...
重要なのは、乗算のオーバーフローを**検査する義務**が実装側にあることだ。
...
「その場で広げられればポインタはそのまま、無理なら新領域に**コピーして移動**」
...
## 「確保したら解放する」の難しさ — 所有権という見方

API の最後に、仕様ではなく**規律**の話をしておきたい。
